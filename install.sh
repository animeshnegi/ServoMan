...
servoman ALL=(root) NOPASSWD: /usr/bin/systemctl, /bin/systemctl, /usr/sbin/ufw, /usr/bin/ufw, /usr/bin/certbot, /snap/bin/certbot, /usr/bin/docker, /usr/bin/pg_dump, /usr/bin/pg_restore, /usr/bin/psql, /usr/bin/createdb, /usr/bin/dropdb, /usr/bin/mysqldump, /usr/bin/mysql, /usr/bin/ssh-keygen, /usr/bin/shutdown, /usr/bin/tar, /usr/bin/stat, /usr/bin/mkdir, /usr/bin/chmod, /usr/bin/cat, /usr/bin/find, /usr/bin/journalctl, /usr/bin/apt-get, /usr/sbin/runuser, /usr/bin/runuser, /usr/sbin/nginx, /usr/bin/nginx, /bin/rm, /usr/bin/rm, /bin/ln, /usr/bin/ln, /usr/bin/install, /usr/bin/chown, /usr/bin/test, /usr/sbin/asterisk, /usr/bin/asterisk
EOF
